/** @const */
export const SHIFT_SCAN_CODE = 0x2a

/** @const */
export const SCAN_CODE_RELEASE = 0x80
...
export function KeyboardAdapter(bus) {
  ...
  let charmap = new Uint16Array([
    ...
    0x39, 0xe049, 0xe051, 0xe04f, 0xe047, 0xe04b, 0xe048, 0xe04d, 0x50, 0, 0, 0,
    0, 0x52, 0x53, 0,
  ...
  function blur_handler(e) {
    ...
    let keys = Object.keys(keys_pressed),
      key
