...
/** @const */ export const E8390_CMD = 0x00 /* The command register (for all pages) */

/* Page 0 register offsets. */
/** @const */ export const EN0_CLDALO = 0x01 /* Low byte of current local dma addr RD */
/** @const */ export const EN0_STARTPG = 0x01 /* Starting page of ring bfr WR */
/** @const */ export const EN0_CLDAHI = 0x02 /* High byte of current local dma addr RD */
/** @const */ export const EN0_STOPPG = 0x02 /* Ending page +1 of ring bfr WR */
/** @const */ export const EN0_BOUNDARY = 0x03 /* Boundary page of ring bfr RD WR */
/** @const */ export const EN0_TSR = 0x04 /* Transmit status reg RD */
/** @const */ export const EN0_TPSR = 0x04 /* Transmit starting page WR */
/** @const */ export const EN0_NCR = 0x05 /* Number of collision reg RD */
/** @const */ export const EN0_TCNTLO = 0x05 /* Low byte of tx byte count WR */
/** @const */ export const EN0_FIFO = 0x06 /* FIFO RD */
/** @const */ export const EN0_TCNTHI = 0x06 /* High byte of tx byte count WR */
/** @const */ export const EN0_ISR = 0x07 /* Interrupt status reg RD WR */
/** @const */ export const EN0_CRDALO = 0x08 /* low byte of current remote dma address RD */
/** @const */ export const EN0_RSARLO = 0x08 /* Remote start address reg 0 */
/** @const */ export const EN0_CRDAHI = 0x09 /* high byte, current remote dma address RD */
/** @const */ export const EN0_RSARHI = 0x09 /* Remote start address reg 1 */
/** @const */ export const EN0_RCNTLO = 0x0a /* Remote byte count reg WR */
/** @const */ export const EN0_RCNTHI = 0x0b /* Remote byte count reg WR */
/** @const */ export const EN0_RSR = 0x0c /* rx status reg RD */
/** @const */ export const EN0_RXCR = 0x0c /* RX configuration reg WR */
/** @const */ export const EN0_TXCR = 0x0d /* TX configuration reg WR */
/** @const */ export const EN0_COUNTER0 = 0x0d /* Rcv alignment error counter RD */
/** @const */ export const EN0_DCFG = 0x0e /* Data configuration reg WR */
/** @const */ export const EN0_COUNTER1 = 0x0e /* Rcv CRC error counter RD */
/** @const */ export const EN0_IMR = 0x0f /* Interrupt mask reg WR */
/** @const */ export const EN0_COUNTER2 = 0x0f /* Rcv missed frame error counter RD */

/** @const */ export const NE_DATAPORT = 0x10 /* NatSemi-defined port window offset. */
/** @const */ export const NE_RESET = 0x1f /* Issue a read to reset, a write to clear. */

/* Bits in EN0_ISR - Interrupt status register */
/** @const */ export const ENISR_RX = 0x01 /* Receiver, no error */
/** @const */ export const ENISR_TX = 0x02 /* Transmitter, no error */
/** @const */ export const ENISR_RX_ERR = 0x04 /* Receiver, with error */
/** @const */ export const ENISR_TX_ERR = 0x08 /* Transmitter, with error */
/** @const */ export const ENISR_OVER = 0x10 /* Receiver overwrote the ring */
/** @const */ export const ENISR_COUNTERS = 0x20 /* Counters need emptying */
/** @const */ export const ENISR_RDC = 0x40 /* remote dma complete */
/** @const */ export const ENISR_RESET = 0x80 /* Reset completed */
/** @const */ export const ENISR_ALL = 0x3f /* Interrupts we will enable */

/** @const */ export const ENRSR_RXOK = 0x01 /* Received a good packet */

/** @const */ export const START_PAGE = 0x40
/** @const */ export const START_RX_PAGE = 0x40 + 12
/** @const */ export const STOP_PAGE = 0x80
 ...
 */
export class Ne2k {
  constructor(cpu, bus, preserve_mac_from_state_image) {
    /** @const @type {CPU} */
    this.cpu = cpu
    ...
    io.register_write(this.port | E8390_CMD, this, function (data_byte) {
      ...
      if (data_byte & 4) {
        let start = this.tpsr << 8
        let data = this.memory.subarray(start, start + this.tcnt)
  ...
  receive(data) {
    ...
    let packet_length = Math.max(60, data.length)

    let offset = this.curpg << 8
    ...
    if (end > this.pstop << 8) {
      ...
      let cut = (this.pstop << 8) - data_start
      dbg_assert(cut >= 0)
