...
/** @const */
export const DLAB = 0x80

/** @const */ export const UART_IER_MSI = 0x08 /* Modem Status Changed int. */
/** @const */ export const UART_IER_THRI = 0x02 /* Enable Transmitter holding register int. */
/** @const */ export const UART_IER_RDI = 0x01 /* Enable receiver data interrupt */

/** @const */ export const UART_IIR_MSI = 0x00 /* Modem status interrupt (Low priority) */
/** @const */ export const UART_IIR_NO_INT = 0x01
/** @const */ export const UART_IIR_THRI = 0x02 /* Transmitter holding register empty */
/** @const */ export const UART_IIR_RDI = 0x04 /* Receiver data interrupt */
/** @const */ export const UART_IIR_RLSI = 0x06 /* Receiver line status interrupt (High p.) */
/** @const */ export const UART_IIR_CTI = 0x0c /* Character timeout */

/** @const */ export const UART_LSR_DATA_READY = 0x1 // data available
/** @const */ export const UART_LSR_TX_EMPTY = 0x20 // TX (THR) buffer is empty
/** @const */ export const UART_LSR_TRANSMITTER_EMPTY = 0x40 // TX empty and line is idle
...
const dataToClearRegexp = /[\x00-\x08\x0b-\x1f\x7f\x80-\xff]/g
...
UART.prototype.write_data = function (out_byte) {
  ...
  let char = String.fromCharCode(out_byte)
